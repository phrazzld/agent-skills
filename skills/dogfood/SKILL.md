...
description: |
  ...
  other problems. Produces a structured report with full reproduction evidence --
  screenshots, repro videos, and detailed repro steps for every finding.
...
For systematic coverage audits, `/webapp-testing` provides structured Playwright test scenarios across user paths. Complements exploratory dogfooding with methodical coverage when you need both breadth and depth.
