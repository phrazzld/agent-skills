...
Transform a repository from "generic AI agent target" to "finely tuned agent workspace" where autonomous skills (/deliver, /investigate, /pr) operate with full project awareness.
